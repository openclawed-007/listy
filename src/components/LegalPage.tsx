...
export const PrivacyPage: React.FC = () => (
  <LegalPage title="Privacy Policy" updated="25 April 2026">
    ...
    <p>
      ...
      You choose whether visitors can only view or also check off / add / remove
      items, and whether people who are not signed in may edit. People who are
      not signed in can never remove items. Click &ldquo;Stop sharing&rdquo; at
      any time to delete that public document.
    </p>
